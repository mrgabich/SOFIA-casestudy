...
#define _MM_STORE_i32(op1, op2, op3)    vse32_v_i32m1(op1, op2)

//#define _MM_ADD_i64     	__builtin_epi_vadd_1xi64
#define _MM_ADD_i64(op1, op2, op3) vadd_vv_i64m1(op1, op2)

//#define _MM_ADD_i32     	__builtin_epi_vadd_2xi32
#define _MM_ADD_i32(op1, op2, op3) vadd_vv_i32m1(op1, op2)

//#define _MM_SUB_i64			  __builtin_epi_vsub_1xi64
#define _MM_SUB_i64(op1, op2, op3) vsub_vv_i64m1(op1, op2)

//#define _MM_SUB_i32			  __builtin_epi_vsub_2xi32
#define _MM_SUB_i32(op1, op2, op3)  vsub_vv_i32m1(op1, op2)
...
#define _MM_MUL_i32(op1, op2, op3) vmul_vv_i32m1(op1, op2)

//#define _MM_DIV_i64       __builtin_epi_vdiv_1xi64
#define _MM_DIV_i64(op1, op2, op3) vdiv_vv_i64m1(op1, op2)

//#define _MM_DIV_i32       __builtin_epi_vdiv_2xi32
#define _MM_DIV_i32(op1, op2, op3) vdiv_vv_i32m1(op1, op2)
...
#define _MM_MIN_i32(op1, op2, op3) vmin_vv_i32m1(op1, op2)

//#define _MM_MAX_i64         __builtin_epi_vmax_1xi64
#define _MM_MAX_i64(op1, op2, op3) vmax_vv_i64m1(op1, op2)
...
#define _MM_SLL_i64(op1, op2, op3) vsll_vv_i64m1(op1, op2)
...
#define _MM_AND_i32(op1, op2, op3) vand_vv_i32m1(op1, op2)

//#define _MM_OR_i64     		__builtin_epi_vor_1xi64
#define _MM_OR_i64(op1, op2, op3) vor_vv_i64m1(op1, op2)

//#define _MM_OR_i32     		__builtin_epi_vor_2xi32
#define _MM_OR_i32(op1, op2, op3) vor_vv_i32m1(op1, op2)

//#define _MM_XOR_i64     	__builtin_epi_vxor_1xi64
#define _MM_XOR_i64(op1, op2, op3) vxor_vv_i64m1(op1, op2)

//#define _MM_XOR_i32     	__builtin_epi_vxor_2xi32
#define _MM_XOR_i32(op1, op2, op3) vxor_vv_i32m1(op1, op2)
...
#define _MM_MERGE_i64(op1, op2, op3, op4)  vmerge_vvm_i64m1(op3, op1, op2)

//#define _MM_MERGE_i32  		__builtin_epi_vmerge_2xi32
#define _MM_MERGE_i32(op1, op2, op3, op4)  vmerge_vvm_i32m1(op3, op1, op2)
...
#define _MM_LOAD_f64(op1, op2) vle64_v_f64m1(op1)
...
#define _MM_STORE_f32(op1, op2, op3) vse32_v_f32m1(op1, op2)

//#define _MM_MUL_f64     	__builtin_epi_vfmul_1xf64
#define _MM_MUL_f64(op1, op2, op3) vfmul_vv_f64m1(op1, op2)

//#define _MM_MUL_f32     	__builtin_epi_vfmul_2xf32
#define _MM_MUL_f32(op1, op2, op3) vfmul_vv_f32m1(op1, op2)

//#define _MM_ADD_f64     	__builtin_epi_vfadd_1xf64
#define _MM_ADD_f64(op1, op2, op3) vfadd_vv_f64m1(op1, op2)

//#define _MM_ADD_f32     	__builtin_epi_vfadd_2xf32
#define _MM_ADD_f32(op1, op2, op3) vfadd_vv_f32m1(op1, op2)

//#define _MM_SUB_f64     	__builtin_epi_vfsub_1xf64
#define _MM_SUB_f64(op1, op2, op3) vfsub_vv_f64m1(op1, op2)
...
#define _MM_SQRT_f64(op1, op2) vfsqrt_v_f64m1(op1)
...
#define _MM_MIN_f32(op1, op2, op3) vfmin_vv_f32m1(op1, op2)

//#define _MM_MAX_f64         __builtin_epi_vfmax_1xf64
#define _MM_MAX_f64(op1, op2, op3) vfmax_vv_f64m1(op1, op2)

//#define _MM_MAX_f32         __builtin_epi_vfmax_2xf32
#define _MM_MAX_f32(op1, op2, op3) vfmax_vv_f32m1(op1, op2)
...
#define _MM_VFSGNJN_f64(op1, op2, op3) vfsgnjn_vv_f64m1(op1, op2)

//#define _MM_VFSGNJN_f32     __builtin_epi_vfsgnjn_2xf32
#define _MM_VFSGNJN_f32(op1, op2, op3) vfsgnjn_vv_f32m1(op1, op2)

//#define _MM_VFSGNJX_f64     __builtin_epi_vfsgnjx_1xf64
#define _MM_VFSGNJX_f64(op1, op2, op3) vfsgnjx_vv_f64m1(op1, op2)
...
#define _MM_MACC_f64(op1, op2, op3, op4) vfmacc_vv_f64m1(op1, op2, op3)

//#define _MM_MACC_f32  		__builtin_epi_vfmacc_2xf32
#define _MM_MACC_f32(op1, op2, op3, op4) vfmacc_vv_f32m1(op1, op2, op3)
...
#define _MM_VFCVT_F_X_f64(op1, op2) vfcvt_f_x_v_f64m1(op1)

//#define _MM_VFCVT_F_X_f32   __builtin_epi_vfcvt_f_x_2xf32_2xi32
#define _MM_VFCVT_F_X_f32(op1, op2) vfcvt_f_x_v_f32m1(op1)

//#define _MM_VFCVT_X_F_i64   __builtin_epi_vfcvt_x_f_1xi64_1xf64
#define _MM_VFCVT_X_F_i64(op1, op2) vfcvt_x_f_v_i64m1(op1)

//#define _MM_VFCVT_X_F_i32   __builtin_epi_vfcvt_x_f_2xi32_2xf32
#define _MM_VFCVT_X_F_i32(op1, op2) vfcvt_x_f_v_i32m1(op1)

//#define _MM_VFWCVT_F_F_f64  __builtin_epi_vfwcvt_f_f_2xf64_2xf32
#define _MM_VFWCVT_F_F_f64(op1, op2) vfwcvt_f_f_v_f64m2(op1)
...
#define _MM_VSLIDEDOWN_i64(op1, op2, op3) vslide1down_vx_i64m1(op1, op2)

//#define _MM_VSLIDE1DOWN_i32    __builtin_epi_vslide1down_2xi32
#define _MM_VSLIDE1DOWN_i32(op1, op2, op3) vslide1down_vx_i32m1(op1, op2)
...
#define _MM_VSLIDEDOWN_f64(op1, op2, op3) vfslide1down_vf_f64m1(op1, op2)

//#define _MM_VSLIDE1DOWN_f32    __builtin_epi_vslide1down_2xf32
#define _MM_VSLIDE1DOWN_f32(op1, op2, op3) vfslide1down_vf_f32m1(op1, op2)
...
#define _MM_VMSLT_i64(op1, op2, op3) vmslt_vv_i64m1_b64(op1, op2)

//#define _MM_VMSLT_i32     __builtin_epi_vmslt_2xi32
#define _MM_VMSLT_i32(op1, op2, op3) vmslt_vv_i32m1_b32(op1, op2)

//#define _MM_VMSEQ_i64		__builtin_epi_vmseq_1xi64							
#define _MM_VMSEQ_i64(op1, op2, op3) vmseq_vv_i64m1_b64(op1, op2)

//#define _MM_VMSEQ_i32		__builtin_epi_vmseq_2xi32
#define _MM_VMSEQ_i32(op1, op2, op3) vmseq_vv_i32m1_b32(op1, op2)

// Fp

//#define _MM_VFGT_f64        __builtin_epi_vmfgt_1xf64
#define _MM_VFGT_f64(op1, op2, op3) vmfgt_vv_f64m1_b64(op1, op2)

//#define _MM_VFGT_f32        __builtin_epi_vmfgt_2xf32
#define _MM_VFGT_f32(op1, op2, op3) vmfgt_vv_f32m1_b32(op1, op2)

//#define _MM_VFGE_f64        __builtin_epi_vmfge_1xf64
#define _MM_VFGE_f64(op1, op2, op3) vmfge_vv_f64m1_b64(op1, op2)

//#define _MM_VFGE_f32        __builtin_epi_vmfge_2xf32
#define _MM_VFGE_f32(op1, op2, op3) vmfge_vv_f32m1_b32(op1, op2)

//#define _MM_VFLT_f64        __builtin_epi_vmflt_1xf64
#define _MM_VFLT_f64(op1, op2, op3) vmflt_vv_f64m1_b64(op1, op2)

//#define _MM_VFLT_f32        __builtin_epi_vmflt_2xf32
#define _MM_VFLT_f32(op1, op2, op3) vmflt_vv_f32m1_b32(op1, op2)

//#define _MM_VFLE_f64        __builtin_epi_vmfle_1xf64
#define _MM_VFLE_f64(op1, op2, op3) vmfle_vv_f64m1_b64(op1, op2)

//#define _MM_VFLE_f32        __builtin_epi_vmfle_2xf32
#define _MM_VFLE_f32(op1, op2, op3) vmfle_vv_f32m1_b32(op1, op2)
//---------------------------------------------------------------------------
