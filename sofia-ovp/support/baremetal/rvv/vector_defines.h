...
#define _MMR_4xf64          vfloat32m2_t //<vscale x 4 x float> //__epi_4xf3  2
...
#define _MM_CAST_u64_i64(op1)     __riscv_vreinterpret_v_u64m1_i64m1(op1)

#define _MM_CAST_i64_u64(op1)     __riscv_vreinterpret_v_i64m1_u64m1(op1)

#define _MM_CAST_f64_i64(op1)     __riscv_vreinterpret_v_f64m1_i64m1(op1)

#define _MM_CAST_f64_u64(op1)     __riscv_vreinterpret_v_f64m1_u64m1(op1)

#define _MM_CAST_i64_f64(op1)     __riscv_vreinterpret_v_i64m1_f64m1(op1)

#define _MM_CAST_u32_i32(op1)     __riscv_vreinterpret_v_u32m1_i32m1(op1)

#define _MM_CAST_f32_i32(op1)     __riscv_vreinterpret_v_f32m1_i32m1(op1)

#define _MM_CAST_f32_u32(op1)     __riscv_vreinterpret_v_f32m1_u32m1(op1)

#define _MM_CAST_i32_f32(op1)     __riscv_vreinterpret_v_i32m1_f32m1(op1)


#define _MM_CAST_i64_i32(op1)     __riscv_vreinterpret_v_i64m1_i32m1(op1)
...
#define _MM_LOAD_u64(op1, op2)     __riscv_vle64_v_u64m1(op1, op2)
...
#define _MM_LOAD_INDEX_i64(op1, op2, op3)  __riscv_vloxei64_v_i64m1(op1, op2, op3)

//#define _MM_LOAD_INDEX_i32 __builtin_epi_vload_indexed_2xi32
#define _MM_LOAD_INDEX_i32(op1, op2, op3) __riscv_vloxei32_v_i32m1(op1, op2, op3)
...
0.9/1.0:
vint64m1_t __riscv_vadd_vv_i64m1_m (vbool64_t mask, __riscv_vint64m1_t maskedoff, __riscv_vint64m1_t op1, __riscv_vint64m1_t op2);
*/
#define _MM_ADD_i64_MASK(op1, op2, op3, op4, op5) __riscv_vadd_vv_i64m1_m(op4, op1, op2, op3, op5)
...
#define _MM_REM_i64(op1, op2, op3) __riscv_vrem_vv_i64m1(op1, op2, op3)

//#define _MM_REM_i32       __builtin_epi_vrem_2xi32
#define _MM_REM_i32(op1, op2, op3) __riscv_vrem_vv_i32m1(op1, op2, op3)
...
0.9/1.0:
vint64m1_t __riscv_vmv_v_x_i64m1 (int64_t src);
*/
...
#define _MM_MAX_i32(op1, op2, op3) __riscv_vmax_vv_i32m1(op1, op2, op3)
...
#define _MM_SRL_u64(op1, op2, op3) __riscv_vsrl_vv_u64m1(op1, op2, op3)

//#define _MM_SRL_i32         __builtin_epi_vsrl_2xi32
#define _MM_SRL_u32(op1, op2, op3) __riscv_vsrl_vv_u32m1(op1, op2, op3)
...
#define _MM_NOT_i64(x)  __riscv_vnot_v_i64m1(x)

//#define _MM_NOT_i32(x)         _MM_XOR_i32((x),(x), gvl) 
#define _MM_NOT_i32(x) __riscv_vnot_v_i32m1(x)
...
0.9/1.0:
vint64m1_t __riscv_vredsum_vs_i64m1_i64m1 (vint64m1_t dst, __riscv_vint64m1_t __riscv_vector, __riscv_vint64m1_t scalar);
*/
//#define _MM_REDSUM_i64       __builtin_epi_vredsum_1xi64 
#define _MM_REDSUM_i64(op1, op2, op3) __riscv_vredsum_vs_i64m1_i64m1(op2, op1, op2, op3)

//#define _MM_REDSUM_i32       __builtin_epi_vredsum_2xi32 
#define _MM_REDSUM_i32(op1, op2, op3) __riscv_vredsum_vs_i32m1_i32m1(op2, op1, op2, op3)
...
0.9/1.0:
vint64m1_t __riscv_vmerge_vvm_i64m1 (vbool64_t mask, __riscv_vint64m1_t op1, __riscv_vint64m1_t op2);
*/
...
#define _MM_SUB_f32_MASK(op1, op2, op3, op4, op5) __riscv_vfsub_vv_f32m1_m(op4, op1, op2, op3, op5)
...
#define _MM_ADD_f32_MASK(op1, op2, op3, op4, op5) __riscv_vfadd_vv_f32m1_m(op4, op1, op2, op3, op5)
...
#define _MM_DIV_4xf32(op1, op2, op3)  __riscv_vfdiv_vv_f32m2(op1, op2, op3)
...
#define _MM_VFSGNJ_f64(op1, op2, op3) __riscv_vfsgnj_vv_f64m1(op1, op2, op3)

//#define _MM_VFSGNJ_f32      __builtin_epi_vfsgnj_2xf32
#define _MM_VFSGNJ_f32(op1, op2, op3) __riscv_vfsgnj_vv_f32m1(op1, op2, op3)
...
0.9/1.0:
vfloat64m1_t __riscv_vmerge_vvm_f64m1 (vbool64_t mask, __riscv_vfloat64m1_t op1, __riscv_vfloat64m1_t op2);
*/
...
#define _MM_REDSUM_f64(op1, op2, op3) __riscv_vfredosum_vs_f64m1_f64m1(op2, op1, op2, op3)

//#define _MM_REDSUM_f32      __builtin_epi_vfredsum_2xf32
#define _MM_REDSUM_f32(op1, op2, op3) __riscv_vfredosum_vs_f32m1_f32m1(op2, op1, op2, op3)
...
#define _MM_VFNCVT_F_F_f32(op1, op2) __riscv_vfncvt_f_f_w_f32m1(op1, op2)

//#define _MM_VFWCVT_F_X_f64  __builtin_epi_vfwcvt_f_x_2xf64_2xi32
#define _MM_VFWCVT_F_X_f64(op1, op2) __riscv_vfwcvt_f_x_v_f64m2(op1, op2)

//#define _MM_VFCVT_f32_i32   __builtin_epi_vfcvt_f_x_2xf32_2xi32
#define _MM_VFCVT_f32_i32(op1, op2) __riscv_vfcvt_f_x_v_f32m1(op1, op2)
...
0.9/1.0:
vint32m2_t __riscv_vslideup_vx_i32m2 (vint32m2_t dst, __riscv_vint32m2_t src, size_t offset)
*/
...
#define _MM_VSLIDEDOWN_i32(op1, op2, op3) __riscv_vslidedown_vx_i32m1(op1, op2, op3)

//#define _MM_VSLIDEDOWN_i64    __builtin_epi_vslidedown_1xi64
#define _MM_VSLIDEDOWN_i64(op1, op2, op3) __riscv_vslidedown_vx_i64m1(op1, op2, op3)
...
//0.9 float32_t __riscv_vfmv_f_s_f32m1_f32 (vfloat32m1_t src); 
...
#define _MM_VSLIDEDOWN_f32(op1, op2, op3) __riscv_vfslidedown_vf_f32m1(op1, op2, op3)

//#define _MM_VSLIDEDOWN_f64    __builtin_epi_vslidedown_1xf64
#define _MM_VSLIDEDOWN_f64(op1, op2, op3) __riscv_vfslidedown_vf_f64m1(op1, op2, op3)
...
#define _MM_CAST_i64_i1(op1, op2) __riscv_vmerge_vxm_i64m1(__riscv_vundefined_i64m1(), 1, op1, op2)

//#define _MM_CAST_i32_i1      __builtin_epi_cast_2xi32_2xi1
#define _MM_CAST_i32_i1(op1, op2) __riscv_vmerge_vxm_i32m1(__riscv_vundefined_i32m1(), 1, op1, op2)
