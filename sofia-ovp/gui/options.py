...
class parseArgs():
    def __init__(self):
        ...
        self.options.append(optionsFIM(name="Vector Bit Width",    buttom="string",  buttomobj=None, entry=None, module="FI", command="--vectorbw",         action="store",         type="int",     dest="vecbw",                                       default=512,                    help="Default bit width of Vector Registers"))
